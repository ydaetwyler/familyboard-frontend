...
const Dashboard = () => {
    ...
    return (
        <div className={(bgSelection ? bgSelection.value : 'bg-clouds') + " w-full min-h-screen sm:h-[160vh] h-[200vh] overflow-x-hidden overflow-y-auto"}>
            <div className="pt-2 pl-2 flex flex-row w-full justify-between z-50 pb-1 bg-white/[.1]">
                <h1 ref={toTop} className="text-2xl lg:text-4xl font-bold text-white font font-['Righteous']">Family Board</h1>
            ...
            <ActivityList familyID={data.getFamily ? data.getFamily._id : null} toTop={toTop} />
        </div>
    )
}
